...
const apiInventory = import.meta.env.VITE_INVENTORY; //link from the .env file

const apiHealthCheck = import.meta.env.VITE_CHECK; //link from the .env file

const apiCars = import.meta.env.VITE_CAR; //link from the .env file
